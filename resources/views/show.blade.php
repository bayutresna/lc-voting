                ...
                <div x-cloak
                    ...
                    <form class="space-y-4 px-4 py-6" action="">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button type="submit" class="flex text-white items-center justify-center w-1/2 h-11 text-sm font-semibold rounded-xl bg-blue border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 space-x-3">

                                Post Comment
                            </button>
                            <button type="button" class="flex items-center justify-center w-32 h-11 text-sm font-semibold rounded-xl bg-gray-200 border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 space-x-3">
